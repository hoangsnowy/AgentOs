// Coherence Phase 2 (A2a) — formats a pipeline progress event into a one-line message for the Spine
...
/// <summary>Maps a <see cref="PipelineProgressEvent"/> to a one-line Spine feed message.</summary>
